...
fallback文件应对的是那些已经自行安装了供显示全部汉字的字体的用户，其中还没有制作黑体的汉字部分将空而不书。allideo文件应对的是那些仅一个字体便可显示全部汉字的用户，其中还没有制作黑体的汉字部分将使用花园明朝（HanaMin）取代之，适用于那些仅能应用一个字体的场合。两个字体文件均可以了解到目前遍黑体的制作进度如何。
